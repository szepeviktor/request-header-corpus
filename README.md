...
|---|---|---|---|
| Google Chrome stable | `windows-2025` | ChromeDriver | [HTTP/1.1](raw/chrome/152.0.7977.83/windows-2025/http1/navigation-get.txt) · [HTTP/2](raw/chrome/152.0.7977.83/windows-2025/http2/navigation-get.txt) |
...
| Microsoft Edge stable | `windows-2025` | MSEdgeDriver | [HTTP/1.1](raw/edge/152.0.4191.66/windows-2025/http1/navigation-get.txt) · [HTTP/2](raw/edge/152.0.4191.66/windows-2025/http2/navigation-get.txt) |
