...
| Mozilla Firefox stable | `ubuntu-24.04` | GeckoDriver | [HTTP/1.1](raw/firefox/156.0/ubuntu-24.04/http1/navigation-get.txt) · [HTTP/2](raw/firefox/156.0/ubuntu-24.04/http2/navigation-get.txt) |
